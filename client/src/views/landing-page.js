      ...
      <div className="background">
        ...
        <div className="body">
          ...
          <Row className="responsive">
            <Col lg={12}>
              <h1 className="paddingrand supporthashtag">
                #support your locals
              </h1>
            </Col>
            ...
            <Col lg={4} sm={12} className="nopadding">
              <div className="backgroundgrey">
                ...
                <p>
                  ...
                  kleine Betriebe trifft die Verkaufssperre hart. Wir wollen
                  diesen Betrieben helfen und eine Map für alternative
          ...
          <Row>
            ...
            <Col lg={4} sm={12} className="nopadding">
              <div className="backgroundgrey">
                <h4 className="roteschrift">
                  Bilder die wir verhindern wollen.
                </h4>
                <p>
                  Werde von deiner lokalen Kundschaft mit deinen
                  „Coronaangeboten" gefunden.
                </p>
              </div>
            </Col>
          </Row>
          ...
          <Row>
            ...
            <Col lg={8} sm={12} className="padding-left" className="nopadding">
              <div className="backgroundgrey">
                <h4>Foto Firlé</h4>
                <p>
                  Foto Firlé ist ein familiengeführtes Fachgeschäft für
                  Fotografie und bereits seit 1930 eine feste Größe in Frankfurt
                  Bockenheim.
                  <br />
                  <br />
                  ...
                  entwickelnde Filme gelegt werden können. iese wird dann einmal
                  am Tag von den Mitarbeitern von Foto Firlé abgeholt und
                  bearbeitet.
                </p>
              </div>
            </Col>
            ...
            <Col lg={8} sm={12} className="padding-right">
              <div className="backgroundgrey">
                ...
                <p>
                  ...
                  Alternative Dienstleistung
                  <br />
                  Die Mitarbeiter führen die Kunden via FaceTime durch das
                  Geschäft. Sie beraten und zeigen, sodass der Kunde ein
                  Einkaufserlebnis hat. Bezahlt wird am Ende über PayPal.
                </p>
              </div>
            </Col>
        ...
        <footer>
          <Row>
            ...
            <Col lg={4}>
              ...
              <img
                className="wirgegencorona"
                src="/img/wirgegencoronalogo.png"
              />
            </Col>
          </Row>
        </footer>
